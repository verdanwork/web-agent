...
import { Call, CreateSquadDTO, CreateAssistantDTO, AssistantOverrides } from './api';
...
export default class Vapi extends VapiEventEmitter {
    ...
    private sleep;
    start(assistant?: CreateAssistantDTO | string, assistantOverrides?: AssistantOverrides, squad?: CreateSquadDTO | string): Promise<Call | null>;
